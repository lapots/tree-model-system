...
The `home-routes` handler in the `tree-model-system.routes.home` namespace
...
The `home-page` function will in turn call the `tree-model-system.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/tree_model_system/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `tree-model-system.handler` namespace:
...
Request middleware functions are located under the `tree-model-system.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `tree-model-system.dev-middleware` namespace found in
